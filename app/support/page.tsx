...
import { EnvelopeIcon, GlobeAltIcon, UserCircleIcon } from "@heroicons/react/24/outline";
    ...
    <div>
      ...
      <form className="my-8 ml-2">
        <div className="flex flex-col">
          ...
          <label className="text-gray-300 font-light text-sm mt-2">Subject</label>
          <TextInput id="subject" type="text" placeholder="Subject" />
          <label className="text-gray-300 font-light text-sm mt-2">Message</label>
          <textarea
            className="
        ...
        <section className="mx-2">
          ...
          <div className="text-base font-normal inline-block leading-7">
            ...
            <div className="inline-block">
              ...
              <a href="https://himanshu-joshi.netlify.app" className="text-blue-400 inline-block cursor-pointer mx-2 font-semibold">
                Portfolio Website
              </a>
            ...
            <div className="inline-block align-bottom mt-2">
              ...
              <a
                ...
                <GithubIcon className="h-5 w-5 inline-block mr-2 align-text-bottom" /> GitHub
              </a>
              profile
            </div>
            <br />
...
function TextInput({ type, placeholder, id }: any) {
  return <input className="
    ...
    border-[1px] border-transparent
    focus:border-gray-300
    py-2 px-4 my-2" type={type} placeholder={placeholder} id={id} />
}
